...
def plotlwlrRegression():
    ...
    axs0_title_text = axs[0].set_title("局部加权回归曲线,k=1.0", FontProperties=font)
    axs1_title_text = axs[1].set_title("局部加权回归曲线,k=0.01", FontProperties=font)
    axs2_title_text = axs[2].set_title("局部加权回归曲线,k=0.003", FontProperties=font)
